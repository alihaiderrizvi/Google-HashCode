lst = '''TMMMTTTMMMMTMMTTMTTMTTMMTMMMTTTTTTMTTTTTTMMMMMMMTMMMMTTTMTMMTTTTTTMMMMMTTMTMTMMMTMTTMMTTMMMTTMMMTTTTMTTTMTMMMTTMTMTTMTTMTTTTMMMTTTMMTTMMMTTMMTMTMMTTMMTTMTMMMTMMMTMTTMMTMMTTMTTMMMMMTTTMMMTMMMMMMTMTTMTTTTTMMMMMMTMTMMTTTTMMTTTTMTTTMTMMTTMMTMTTMTTTMTMMTM
...
def slicer(matrix):
    ...
    for x in range(0, len(matrix)-2, 3):
        for y in range(len(matrix[0])):
            ...
            if m >= 4 and t>= 4:
                if y-start < 4:
                    slices.append([matrix[x][start:y+1], matrix[x+1][start:y+1], matrix[x+2][start:y+1]])
                    index.append([x, start, x+2, y])
                else:
                    slices.append([matrix[x][y-3:y+1], matrix[x+1][y-3:y+1], matrix[x+2][y-3:y+1]])
                    index.append([x, y-3, x+2, y])
                start = y+1
                m = 0
                t = 0
            elif m + t >= 12:
                if matrix[x][start] == "M":
                    ...
                    t -= 1
                if matrix[x+1][start] == "M":
                    m -= 1
                else:
                    t -= 1
                if matrix[x+2][start] == "M":
                    m -= 1
                else:
                    t -= 1
    ...
    for x in range(len(matrix)-2, len(matrix), 2):
        for y in range(len(matrix[0])):
            ...
            if m >= 4 and t>= 4:
                if y-start < 6:
                    slices.append([matrix[x][start:y+1], matrix[x+1][start:y+1]])
                    index.append([x, start, x+1, y])
                else:
                    slices.append([matrix[x][y-5:y+1], matrix[x+1][y-5:y+1]])
                    index.append([x, y-5, x+1, y])
                start = y+1
                m = 0
                t = 0
            elif m + t >= 12:
